...
mod tests {
    ...
    #[test]
    fn ternary_succ() {
        assert_eq!(<Succ<U0>>::reify(), 1);
        assert_eq!(<Succ<U7>>::reify(), 8);
        assert_eq!(<Succ<U2>>::reify(), 3);
        assert_eq!(<Succ<U9>>::reify(), 10);
        assert_eq!(<Succ<U5>>::reify(), 6);
        assert_eq!(<Succ<U8>>::reify(), 9);
        assert_eq!(<Succ<U3>>::reify(), 4);
    }

    #[test]
    fn ternary_pred() {
        assert_eq!(<Pred<U7>>::reify(), 6);
        assert_eq!(<Pred<U2>>::reify(), 1);
        assert_eq!(<Pred<U9>>::reify(), 8);
        assert_eq!(<Pred<U5>>::reify(), 4);
        assert_eq!(<Pred<U8>>::reify(), 7);
        assert_eq!(<Pred<U3>>::reify(), 2);
    }

    #[test]
    fn ternary_double_pred() {
        assert_eq!(<DoublePred<U7>>::reify(), 5);
        assert_eq!(<DoublePred<U2>>::reify(), 0);
        assert_eq!(<DoublePred<U9>>::reify(), 7);
        assert_eq!(<DoublePred<U5>>::reify(), 3);
        assert_eq!(<DoublePred<U8>>::reify(), 6);
        assert_eq!(<DoublePred<U3>>::reify(), 1);
    }

    #[test]
    fn ternary_add() {
        assert_eq!(<Add<U0, U10>>::reify(), 10);
        assert_eq!(<Add<U2, U11>>::reify(), 13);
        assert_eq!(<Add<U25, U12>>::reify(), 37);
        assert_eq!(<Add<U10, U18>>::reify(), 28);
        assert_eq!(<Add<U15, U2>>::reify(), 17);
        assert_eq!(<Add<U24, U5>>::reify(), 29);
        assert_eq!(<Add<U13, U1>>::reify(), 14);
        assert_eq!(<Add<U6, U23>>::reify(), 29);
        assert_eq!(<Add<U2, U17>>::reify(), 19);
        assert_eq!(<Add<U26, U25>>::reify(), 51);
    }

    #[test]
    fn ternary_sub() {
        assert_eq!(<Sub<U25, U12>>::reify(), 13);
        assert_eq!(<Sub<U15, U2>>::reify(), 13);
        assert_eq!(<Sub<U24, U5>>::reify(), 19);
        assert_eq!(<Sub<U13, U1>>::reify(), 12);
        assert_eq!(<Sub<U26, U25>>::reify(), 1);
    }
    ...
    fn ternary_sub_undefined() {
        ...
        let _ = <Sub<Sub<U1, U9>, U9>>::reify();
    }

    #[test]
    fn ternary_undef_or_2() {
        assert_eq!(<UndefOr2<Sub<Sub<U1, U9>, U9>, U2, Nat2<U1, U0>>>::reify(), (1, 0));
        assert_eq!(<UndefOr2<Sub<Sub<U2, U1>, U1>, U2, Nat2<U0, U1>>>::reify(), (0, 2));
    }

    #[test]
    fn ternary_mul() {
        assert_eq!(<Mul<U0, U0>>::reify(), 0);
        assert_eq!(<Mul<U2, U2>>::reify(), 4);
        assert_eq!(<Mul<U7, U9>>::reify(), 63);
        assert_eq!(<Mul<U2, U1>>::reify(), 2);
        assert_eq!(<Mul<U9, U5>>::reify(), 45);
        assert_eq!(<Mul<U5, U8>>::reify(), 40);
        assert_eq!(<Mul<U8, U2>>::reify(), 16);
        assert_eq!(<Mul<U3, U2>>::reify(), 6);
    }

    #[test]
    fn ternary_div() {
        assert_eq!(<Div<U0, U1>>::reify(), 0);
        assert_eq!(<Div<U2, U2>>::reify(), 1);
        assert_eq!(<Div<U8, U2>>::reify(), 4);
        assert_eq!(<Div<U7, U9>>::reify(), 0);
        assert_eq!(<Div<U2, U1>>::reify(), 2);
        assert_eq!(<Div<U9, U5>>::reify(), 1);
        assert_eq!(<Div<U5, U8>>::reify(), 0);
        assert_eq!(<Div<U3, U2>>::reify(), 1);
    }

    #[test]
    fn ternary_rem() {
        assert_eq!(<Rem<U0, U1>>::reify(), 0);
        assert_eq!(<Rem<U2, U2>>::reify(), 0);
        assert_eq!(<Rem<U8, U2>>::reify(), 0);
        assert_eq!(<Rem<U7, U9>>::reify(), 7);
        assert_eq!(<Rem<U2, U1>>::reify(), 0);
        assert_eq!(<Rem<U9, U5>>::reify(), 4);
        assert_eq!(<Rem<U5, U8>>::reify(), 5);
        assert_eq!(<Rem<U3, U2>>::reify(), 1);
    }
}
