...
mod tests {
    ...
    fn balanced_ternary_cmp() {
        assert_eq!(<Cmp<S0, S0, SN1, S0, SP1>>::reify(), 0);
        assert_eq!(<Cmp<SN7, SP9, SN1, S0, SP1>>::reify(), -1);
        assert_eq!(<Cmp<SP2, SP2, SN1, S0, SP1>>::reify(), 0);
        assert_eq!(<Cmp<SN2, SN1, SN1, S0, SP1>>::reify(), -1);
        assert_eq!(<Cmp<SN9, SP5, SN1, S0, SP1>>::reify(), -1);
        assert_eq!(<Cmp<SP5, SN8, SN1, S0, SP1>>::reify(), 1);
        assert_eq!(<Cmp<SN8, SP2, SN1, S0, SP1>>::reify(), -1);
        assert_eq!(<Cmp<SP3, SP2, SN1, S0, SP1>>::reify(), 1);
        assert_eq!(<Cmp<S0, SN5, SN1, S0, SP1>>::reify(), 1);
        assert_eq!(<Cmp<S0, SN4, SN1, S0, SP1>>::reify(), 1);
        assert_eq!(<Cmp<S0, SN3, SN1, S0, SP1>>::reify(), 1);
        assert_eq!(<Cmp<S0, SN2, SN1, S0, SP1>>::reify(), 1);
        assert_eq!(<Cmp<S0, SN1, SN1, S0, SP1>>::reify(), 1);
        assert_eq!(<Cmp<S0, S0, SN1, S0, SP1>>::reify(), 0);
        assert_eq!(<Cmp<S0, SP1, SN1, S0, SP1>>::reify(), -1);
        assert_eq!(<Cmp<S0, SP2, SN1, S0, SP1>>::reify(), -1);
        assert_eq!(<Cmp<S0, SP3, SN1, S0, SP1>>::reify(), -1);
        assert_eq!(<Cmp<S0, SP4, SN1, S0, SP1>>::reify(), -1);
        assert_eq!(<Cmp<S0, SP5, SN1, S0, SP1>>::reify(), -1);
    }

    #[test]
    fn balanced_ternary_lte_cmp() {
        assert_eq!(<LteCmp<SN7, SP9, S0, SP1>>::reify(), 0);
        assert_eq!(<LteCmp<SP2, SP2, S0, SP1>>::reify(), 0);
        assert_eq!(<LteCmp<SN2, SN1, S0, SP1>>::reify(), 0);
        assert_eq!(<LteCmp<SN9, SP5, S0, SP1>>::reify(), 0);
        assert_eq!(<LteCmp<SP5, SN8, S0, SP1>>::reify(), 1);
        assert_eq!(<LteCmp<SN8, SP2, S0, SP1>>::reify(), 0);
        assert_eq!(<LteCmp<SP3, SP2, S0, SP1>>::reify(), 1);
        assert_eq!(<LteCmp<S0, SN5, S0, SP1>>::reify(), 1);
        assert_eq!(<LteCmp<S0, SN4, S0, SP1>>::reify(), 1);
        assert_eq!(<LteCmp<S0, SN3, S0, SP1>>::reify(), 1);
        assert_eq!(<LteCmp<S0, SN2, S0, SP1>>::reify(), 1);
        assert_eq!(<LteCmp<S0, SN1, S0, SP1>>::reify(), 1);
        assert_eq!(<LteCmp<S0, S0, S0, SP1>>::reify(), 0);
        assert_eq!(<LteCmp<S0, SP1, S0, SP1>>::reify(), 0);
        assert_eq!(<LteCmp<S0, SP2, S0, SP1>>::reify(), 0);
        assert_eq!(<LteCmp<S0, SP3, S0, SP1>>::reify(), 0);
        assert_eq!(<LteCmp<S0, SP4, S0, SP1>>::reify(), 0);
        assert_eq!(<LteCmp<S0, SP5, S0, SP1>>::reify(), 0);
        assert_eq!(<LteCmp<S0, SP2, SP2, SN2>>::reify(), 2);
    }

    #[test]
    fn balanced_ternary_abs_min_three_cmp() {
        assert_eq!(<AbsMinThreeCmp<SP5, SN7, SN8, S0, SP1, SP2>>::reify(), (5, 0));
        assert_eq!(<AbsMinThreeCmp<SP9, SN4, SN1, S0, SP1, SP2>>::reify(), (-1, 2));
        assert_eq!(<AbsMinThreeCmp<SN4, SN1, SN5, S0, SP1, SP2>>::reify(), (-1, 1));
        assert_eq!(<AbsMinThreeCmp<SP2, S0, SP5, S0, SP1, SP2>>::reify(), (0, 1));
        assert_eq!(<AbsMinThreeCmp<SN6, SP8, SP7, S0, SP1, SP2>>::reify(), (-6, 0));
        assert_eq!(<AbsMinThreeCmp<SN7, SN3, SP6, S0, SP1, SP2>>::reify(), (-3, 1));
        assert_eq!(<AbsMinThreeCmp<SP2, SN8, SP3, S0, SP1, SP2>>::reify(), (2, 0));
        assert_eq!(<AbsMinThreeCmp<S0, SP9, SN2, S0, SP1, SP2>>::reify(), (0, 0));
        assert_eq!(<AbsMinThreeCmp<SP7, SN2, SP1, S0, SP1, SP2>>::reify(), (1, 2));
    }

    #[test]
    fn balanced_ternary_succ() {
        assert_eq!(<Succ<S0>>::reify(), 1);
        assert_eq!(<Succ<SN7>>::reify(), -6);
        assert_eq!(<Succ<SP2>>::reify(), 3);
        assert_eq!(<Succ<SN2>>::reify(), -1);
        assert_eq!(<Succ<SN9>>::reify(), -8);
        assert_eq!(<Succ<SP5>>::reify(), 6);
        assert_eq!(<Succ<SN8>>::reify(), -7);
        assert_eq!(<Succ<SP3>>::reify(), 4);
    }

    #[test]
    fn balanced_ternary_pred() {
        assert_eq!(<Pred<S0>>::reify(), -1);
        assert_eq!(<Pred<SN7>>::reify(), -8);
        assert_eq!(<Pred<SP2>>::reify(), 1);
        assert_eq!(<Pred<SN2>>::reify(), -3);
        assert_eq!(<Pred<SN9>>::reify(), -10);
        assert_eq!(<Pred<SP5>>::reify(), 4);
        assert_eq!(<Pred<SN8>>::reify(), -9);
        assert_eq!(<Pred<SP3>>::reify(), 2);
    }

    #[test]
    fn balanced_ternary_abs() {
        assert_eq!(<Abs<S0>>::reify(), 0);
        assert_eq!(<Abs<SN7>>::reify(), 7);
        assert_eq!(<Abs<SP2>>::reify(), 2);
        assert_eq!(<Abs<SN2>>::reify(), 2);
        assert_eq!(<Abs<SN9>>::reify(), 9);
        assert_eq!(<Abs<SP5>>::reify(), 5);
        assert_eq!(<Abs<SN8>>::reify(), 8);
        assert_eq!(<Abs<SP3>>::reify(), 3);
    }

    #[test]
    fn balanced_ternary_add() {
        assert_eq!(<Add<S0, S0>>::reify(), 0);
        assert_eq!(<Add<SN7, SP9>>::reify(), 2);
        assert_eq!(<Add<SP2, SP2>>::reify(), 4);
        assert_eq!(<Add<SN2, SN1>>::reify(), -3);
        assert_eq!(<Add<SN9, SP5>>::reify(), -4);
        assert_eq!(<Add<SP5, SN8>>::reify(), -3);
        assert_eq!(<Add<SN8, SP2>>::reify(), -6);
        assert_eq!(<Add<SP3, SP2>>::reify(), 5);
    }

    #[test]
    fn balanced_ternary_sub() {
        assert_eq!(<Sub<S0, S0>>::reify(), 0);
        assert_eq!(<Sub<SP7, SP9>>::reify(), -2);
        assert_eq!(<Sub<SP2, SP2>>::reify(), 0);
        assert_eq!(<Sub<SN2, SN1>>::reify(), -1);
        assert_eq!(<Sub<SP9, SP5>>::reify(), 4);
        assert_eq!(<Sub<SP5, SN8>>::reify(), 13);
        assert_eq!(<Sub<SN8, SP2>>::reify(), -10);
        assert_eq!(<Sub<SP3, SP2>>::reify(), 1);
    }

    #[test]
    fn balanced_ternary_mul() {
        assert_eq!(<Mul<S0, S0>>::reify(), 0);
        assert_eq!(<Mul<SP2, SP2>>::reify(), 4);
        assert_eq!(<Mul<SN7, SP9>>::reify(), -63);
        assert_eq!(<Mul<SN2, SN1>>::reify(), 2);
        assert_eq!(<Mul<SN9, SP5>>::reify(), -45);
        assert_eq!(<Mul<SP5, SN8>>::reify(), -40);
        assert_eq!(<Mul<SN8, SP2>>::reify(), -16);
        assert_eq!(<Mul<SP3, SP2>>::reify(), 6);
    }

    #[test]
    fn balanced_ternary_div() {
        assert_eq!(<Div<S0, SP1>>::reify(), 0);
        assert_eq!(<Div<SP2, SP2>>::reify(), 1);
        assert_eq!(<Div<SN8, SP2>>::reify(), -4);
        assert_eq!(<Div<SN7, SP9>>::reify(), -1);
        assert_eq!(<Div<SN2, SN1>>::reify(), 2);
        assert_eq!(<Div<SN9, SP5>>::reify(), -2);
        assert_eq!(<Div<SP5, SN8>>::reify(), -1);
        assert_eq!(<Div<SP3, SP2>>::reify(), 1);
    }

    #[test]
    fn balanced_ternary_rem() {
        assert_eq!(<Rem<S0, SP1>>::reify(), 0);
        assert_eq!(<Rem<SP2, SP2>>::reify(), 0);
        assert_eq!(<Rem<SN8, SP2>>::reify(), 0);
        assert_eq!(<Rem<SN7, SP9>>::reify(), 2);
        assert_eq!(<Rem<SN2, SN1>>::reify(), 0);
        assert_eq!(<Rem<SN9, SP5>>::reify(), 1);
        assert_eq!(<Rem<SP5, SN8>>::reify(), -3);
        assert_eq!(<Rem<SP3, SP2>>::reify(), 1);
    }

    #[test]
    fn balanced_ternary_rev() {
        assert_eq!(<Rev<SN9>>::reify(), -1);
        assert_eq!(<Rev<SN8>>::reify(), 8);
        assert_eq!(<Rev<SN7>>::reify(), -7);
        assert_eq!(<Rev<SN6>>::reify(), 2);
        assert_eq!(<Rev<SN5>>::reify(), 11);
        assert_eq!(<Rev<SN4>>::reify(), -4);
        assert_eq!(<Rev<SN3>>::reify(), -1);
        assert_eq!(<Rev<SN2>>::reify(), 2);
        assert_eq!(<Rev<SN1>>::reify(), -1);
        assert_eq!(<Rev<S0>>::reify(), 0);
        assert_eq!(<Rev<SP1>>::reify(), 1);
        assert_eq!(<Rev<SP2>>::reify(), -2);
        assert_eq!(<Rev<SP3>>::reify(), 1);
    }
}
